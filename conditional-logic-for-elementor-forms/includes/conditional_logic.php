...
class Superaddons_Elementor_Conditional_Logic
{
    ...
    public function __construct()
    {
        ...
        add_action("elementor/element/form/section_buttons/before_section_end", array($this, "settiing_bnt"), 10, 2);
    }
    function add_libs()
    {
    ...
    function settiing_bnt($widget, $args)
    {
        $options_logic = apply_filters("yeeaddons_condition_options_logic", $this->yeekit_get_options());
        $options_pro = apply_filters("yeeaddons_condition_options_logic_pro", $this->yeekit_get_options("pro"));
        $widget->add_control(
            'conditional_logic_btn',
            [
        ...
        $widget->add_control(
            ...
            [
                ...
                'default' => 'show',
                'condition' => [
                    'conditional_logic_btn' => 'yes'
                ],
            ]
        );
        $widget->add_control(
            'conditional_logic_trigger_bnt',
            [
        ...
        $repeater->add_control(
            ...
            [
                ...
                'label_block' => true,
                'options'     => $options_logic,   // giữ như bạn đang có
                'default'     => '==',
            ]
        );
        $repeater->add_control(
    ...
    function yeekit_get_options($type = "free")
    {
        if ($type == "free") {
            $options_logic = array(
    ...
    public function pre_render($instance)
    {
        ...
        endforeach;
        if(isset($instance['conditional_logic_btn']) && $instance['conditional_logic_btn'] == 'yes') {
            $datas["elementor-field-type-submit"] = array("display" => $instance['conditional_logic_display_bnt'], "trigger" => $instance['conditional_logic_trigger_bnt'], "datas" => $instance['conditional_logic_datas_bnt']);
        }
?>
